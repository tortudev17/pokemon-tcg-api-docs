...
All API requests must be made over HTTPS. Calls made over plain HTTP will fail and will redirect to HTTPS automatically. API requests without authentication won't fail, but your rate limits are drastically reduced.
